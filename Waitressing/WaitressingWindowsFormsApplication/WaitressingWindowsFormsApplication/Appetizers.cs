...
namespace WaitressingWindowsFormsApplication
{
    public partial class Appetizers : Form
    {
        ...
        private void ChickenWingsButton_Click(object sender, EventArgs e)
        {
            createAppetizer("ChickenWings");
        }

        private void ChickenNuggetsButton_Click(object sender, EventArgs e)
        {
            createAppetizer("ChickenNuggets");
        }

        private void ChickenSkewersButton_Click(object sender, EventArgs e)
        {
            createAppetizer("ChickenSkewers");
        }        
