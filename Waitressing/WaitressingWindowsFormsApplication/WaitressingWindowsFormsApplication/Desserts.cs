...
namespace WaitressingWindowsFormsApplication
{
    public partial class Desserts : Form
    {
        ...
        private void cremeBruleeButton_Click(object sender, EventArgs e)
        {
            createDessert("CremeBrulee");
        }

        private void chocolateCakeButton_Click(object sender, EventArgs e)
        {
            createDessert("ChocolateCake");
        }       

        private void CheesecakeButton_Click(object sender, EventArgs e)
        {
            createDessert("Cheesecake");
        }

        private void IceCreamButton_Click(object sender, EventArgs e)
        {
            createDessert("IceCream");
        }       

        private void createDessert(string i_Name)
        {
            ...
            {
                Dessert dessert = InitializeFoods.InitializeDessert(i_Name, Int32.Parse(quantityText.Text), severalDinerText.Text);                
                showDessert(dessert);
            }
        }
